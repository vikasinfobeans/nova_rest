 ...
 * AuCountries
 *
 * @ORM\Table(name="au_countries", indexes={@ORM\Index(name="ProdID_PT_T", columns={"ProdID", "provider_type", "Territory"}), @ORM\Index(name="SalesDate_index", columns={"SalesDate"})})
 * @ORM\Entity
 */
class AuCountries
{
