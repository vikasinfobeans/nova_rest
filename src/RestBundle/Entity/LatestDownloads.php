 ...
 * LatestDownloads
 *
 * @ORM\Table(name="latest_downloads", indexes={@ORM\Index(name="DownloadLibraryID", columns={"library_id"}), @ORM\Index(name="DownloadPatronID", columns={"patron_id"}), @ORM\Index(name="idxld_created", columns={"created"}), @ORM\Index(name="idxld_library_id_created", columns={"library_id", "created"}), @ORM\Index(name="idxld_prodid", columns={"ProdID"}), @ORM\Index(name="idxld_prodid_provtype", columns={"provider_type", "ProdID"}), @ORM\Index(name="idxld_cmpd", columns={"ProdID", "provider_type"}), @ORM\Index(name="idxld_id_type_created", columns={"ProdID", "provider_type", "created"}), @ORM\Index(name="idxld_cmpd2", columns={"created", "ProdID", "provider_type"})})
 * @ORM\Entity
 */
class LatestDownloads
{
    /**
     * @var integer
     *
